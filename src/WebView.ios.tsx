...
import RNCTPWebView, { Commands, NativeProps } from './RNCWebViewNativeComponent';
import RNCTPWebViewModule from './NativeRNCTPWebViewModule';
  ...
  (
    ...
    const onShouldStartLoadWithRequestCallback = useCallback(
      (shouldStart: boolean, _url: string, lockIdentifier = 0) => {
        RNCTPWebViewModule.shouldStartLoadWithLockIdentifier(
          shouldStart,
          lockIdentifier
        );
      },
    ...
    if (viewState === 'LOADING') {
      ...
      console.error(`RNCTPWebView invalid state encountered: ${viewState}`);
    }
    ...
    const NativeWebView =
      (nativeConfig?.component as typeof RNCTPWebView | undefined) || RNCTPWebView;
