...
namespace facebook::react {
  ...
  class JSI_EXPORT NativeRNCTPWebViewModuleCxxSpecJSI : public TurboModule {
protected:
  NativeRNCTPWebViewModuleCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
template <typename T>
class JSI_EXPORT NativeRNCTPWebViewModuleCxxSpec : public TurboModule {
public:
  ...
  static constexpr std::string_view kModuleName = "RNCTPWebViewModule";

protected:
  NativeRNCTPWebViewModuleCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule(std::string{NativeRNCTPWebViewModuleCxxSpec::kModuleName}, jsInvoker),
      delegate_(reinterpret_cast<T*>(this), jsInvoker) {}


private:
  class Delegate : public NativeRNCTPWebViewModuleCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeRNCTPWebViewModuleCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {
  ...
  private:
    friend class NativeRNCTPWebViewModuleCxxSpec;
    T *instance_;
  };
