...
public class RNCTPWebViewManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode> & RNCTPWebViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public RNCTPWebViewManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
